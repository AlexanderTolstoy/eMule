...
int AFX_CDECL CWebServer::_DownloadCmp(void *prm, void const *pv1, void const *pv2)
{
	...
	case DOWN_SORT_NAME:
		...
		break;
	case DOWN_SORT_SIZE:
		iOrd = sgn(p1.m_qwFileSize - p2.m_qwFileSize);
		break;
	case DOWN_SORT_TRANSFERRED:
		iOrd = sgn(p1.m_qwFileTransferred - p2.m_qwFileTransferred);
		break;
...
int AFX_CDECL CWebServer::_SharedCmp(void *prm, void const *pv1, void const *pv2)
{
	...
	case SHARED_SORT_SIZE:
		iOrd = sgn((sint64)(p1.m_qwFileSize - p2.m_qwFileSize));
		break;
	case SHARED_SORT_TRANSFERRED:
		iOrd = sgn((sint64)(p1.nFileTransferred - p2.nFileTransferred));
		break;
	case SHARED_SORT_ALL_TIME_TRANSFERRED:
		iOrd = sgn((sint64)(p1.nFileAllTimeTransferred - p2.nFileAllTimeTransferred));
		break;
