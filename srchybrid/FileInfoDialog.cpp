	...
	bool Initialize()
	{
		if (!m_bInitialized) {
			...
			if (m_hLib != NULL) {
				...
				} else if (ullVersion < MAKEDLLVERULL(20, 9, 0, 0)) { //here ullVersion >= 7.0
